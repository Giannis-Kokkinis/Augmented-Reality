...
# 3rd Deliverable 
- Για το πρωτο σκελος κατεβασα ενα 3d μοντελο και το δηλωσα στο assets.Επειτα για να διαμορφωσω το μεγεθος και την θεση εφτιαξα ενα a-entity με id-paris και προσθεσα 
  gps-entity-place για τις συντεταγμενες + text show.Προσθεσα μια εντολη a-camera και εβαλα τις συντεταγμενες στο gps-reader
- Για το δευτερο σκελος εφτιαξα μια εντολη text που δηλωσα το κειμενο και τα χαρακτηριστικα αυτου του κειμενου.Προσθεσα μια εντολη script στο τελος για τις λειτουργιες
  των click.
- Για το τελικο σκελος εβαλα στο syros.html τις συντεταγμενες στο a-entity εβαλα src και μεσα του , την img της τοποθεσιας
